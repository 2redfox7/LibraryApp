    ...
    public partial class Form3 : Form
    {
        ...
        private void UpdateLists()
        {
            ...
            if (list != null)
            {
                ...
                label3.Text = $"Рейтинг: {Math.Round(sum / list.Count, 1)}";
            }
            else
            {
                label3.Text += " отсутствует";
                listBox1.Items.Add("Пока у книги нет отзывов... Будьте первым!");
            }
        }
        public Form3(IUser user, IBook book)
        {
            InitializeComponent();
            currentUser = user;
            currentBook = book;
