...
namespace Library.App
{
    public partial class Form2 : Form
    {
        ...
        private static ILibrary CreateLibrary(string address)
        {
        ...
        public Form2()
        {
            ...
            var library = CreateLibrary("ул. Интерфейсная, 3");
            label1.Text = $"{library}!";
        }
        ...
        private void registration_Click(object sender, EventArgs e)
        {
            ...
            else if (passwordReg.Text.Length < 5 || passwordReg.Text.Length > 13)
            {
                label10.Text = "Пароль не может содержать меньше 5\nили больше 13 символов!";
                return;
            }
